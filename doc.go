...
github.com/khaibin/pgx/v4/stdlib to use pgx as a database/sql compatible driver.
...
mappings between Go and SQL. In addition, pgx uses the github.com/khaibin/pgx/pgtype library to support more types. See
